...
| 02 システム構成 | 19〜24 | 未決 | [03-system-architecture.md](./03-system-architecture.md) |
...
| # | 論点 | 優先度 | 状態 |
| --- | --- | --- | --- |
| 19 | 実行スレッド構成（Worker の分割方針） | 高 | 未決 |
| 20 | ML Runtime の抽象化粒度 | 高 | 未決 |
| 21 | 学習の進捗通知と、中断した Training の回収方式 | 高 | 未決 |
| 22 | Base Model の配信方式 | 中 | 未決 |
| 23 | 容量超過（QuotaExceeded）時の扱い | 中 | 未決 |
| 24 | オフライン動作 / PWA 化の要否 | 低 | 未決 |
